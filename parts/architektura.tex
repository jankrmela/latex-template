...
Architektura se skládá z~několika komponent, které lze rozdělit do dvou kategorií. Komponenty uživatelského rozhraní a~strukturální komponenty. 
...
\noindent Hlavním principem SPA aplikace je stahovat pouze nejnutnější elementy obsahu a~zobrazovat informace intuitivním způsobem, kde je interakce s~uživatelem a~uživatelský požitek první prioritou. Nestahuje se celá stránka po každé interakci, ale stahují se pouze minimální data asynchronně, takže uživatel není vyrušen dlouhým načítáním celé stránky. Překreslují se pouze části, které je nutné aktualizovat. \cite{rady_serverless_2016}

\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-15-58-08.png}{0.9\textwidth}{!}
    \caption{Porovnání životních cyklů aplikace. Zdroj: \cite{topalovich_salesforce_2017}}
    \label{spavstradi}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-16-18-29.png}{0.9\textwidth}{!}
    \caption{Porovnání monolitické architektury s~microservices architekturou. Zdroj: \cite{algorithmia_serverless_2018}}
    \label{comparemicroservices}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-16-29-00.png}{0.9\textwidth}{!}
    \caption{Architektura SPA aplikace z~globálního pohledu. Zdroj: \cite{botto_front-end_2020}}
    \label{spaarchitekture}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-16-31-09.png}{0.9\textwidth}{!}
    \caption{Nejpoužívanější programovací jazyky dle průzkumu StackOverflow z~roku 2019. Zdroj: \cite{stack_overflow_stack_2020}}
    \label{stakoverflowTopLangs}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-16-36-40.png}{0.9\textwidth}{!}
    \caption{Porovnání používanosti s~populárností webových nástrojů. Zdroj: \cite{stack_overflow_stack_2020}}
    \label{stackOverflowLoved}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-16-40-17.png}{0.9\textwidth}{!}
    \caption{Aktuální trend v~používání hlavních webových knihoven. Zdroj: \cite{npmjs_npm_2020}}
    \label{npmtrends}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-17-18-39.png}{0.9\textwidth}{!}
    \caption{Diagram architektury MVC. Zdroj: \cite{margam_model-view-controller_2018}}
    \label{mvcagain}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-17-19-29.png}{0.9\textwidth}{!}
    \caption{Problém komplexních SPA aplikací MVC architektury. Zdroj: \cite{flux_hacker_2014}}
    \label{mvcpast}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-17-47-02.png}{0.9\textwidth}{!}
    \caption{Diagram FLUX architektury. Zdroj: \cite{flux_depth_2020}}
    \label{fluxarchitektura}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-27-17-48-17.png}{0.9\textwidth}{!}
    \caption{Digram Redux cyklu. Zdroj: \cite{rigau_introduction_2018}}
    \label{reduxcycle}
\end{figure}
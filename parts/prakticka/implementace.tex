...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-08-08-10.png}{0.9\textwidth}{!}
    \caption{Ukázka odpovědi z API ancillaries/offers/check}
    \label{apiresponse}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-08-11-35.png}{0.9\textwidth}{!}
    \caption{Nabízené balíčky na základě vybraného tarifu}
    \label{diagramupgrade}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-08-14-04.png}{0.9\textwidth}{!}
    \caption{Požadovaná struktura dat při odesílání}
    \label{apisavebooking}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-16-06-29.png}{0.9\textwidth}{!}
    \caption{Hierarchie komponent (zjednodušeno)}
    \label{hierarchie}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-16-16-54.png}{0.9\textwidth}{!}
    \caption{Výsledný vzhled banneru pouze z Orbit komponent}
    \label{orbit}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-16-50-54.png}{0.9\textwidth}{!}
    \caption{Proces manuálního testování QA testery}
    \label{qa}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-16-57-28.png}{0.9\textwidth}{!}
    \caption{Výsledek spuštěných testů v repozitáři}
    \label{tests}
\end{figure}
...
\begin{figure}[H]
    \centering
    \vlozobrbox{2020-04-28-16-58-23.png}{0.5\textwidth}{!}
    \caption{Průběh testování v integračním prostředí Gitlab}
    \label{gitlab}
\end{figure}
